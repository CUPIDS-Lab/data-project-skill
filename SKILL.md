...
- `references/*.md` — per-framework digests (Cookiecutter, OUHSC, Snakemake, Git/GitHub, Turing Way, Responsible Data, Data Collaboratives, Data Cards Playbook, USDS Playbook, ProPublica Bulletproofing/Collaborative/Collaborate, Quartz Bad Data, OKF).
