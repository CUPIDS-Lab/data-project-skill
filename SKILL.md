...
description: >-
  ...
  "share the data," "zero-copy," "OpenSharing," "Delta Sharing," "audit my repo," even when
...
- `references/*.md` — per-framework digests (Cookiecutter, OUHSC, Snakemake, GitHub (collaboration + project management), Turing Way, Responsible Data, Data Collaboratives, Data Cards Playbook, USDS Playbook, ProPublica (collaboration · contributed-data · bulletproofing), Quartz Bad Data, OKF, Agentic Resource Discovery, Harvard Dataverse Deposit, OpenSharing Protocol).
